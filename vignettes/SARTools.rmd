...
The only file the user has to deal with for an analysis is either `template_script_DESeq2.r` or `template_script_edgeR.r` (downloadable on GitHub). They contain all the code needed for the statistical analysis, and to generate figures, tables and the HTML report.
